...
export class Wrapper_TimetableWishComponent {
  ...
  constructor() {
    this._changed = false;
    this.context = new import0.TimetableWishComponent();
...
class View_TimetableWishComponent_Host0 extends import2.AppView<any> {
  ...
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    ...
    this._TimetableWishComponent_0_3 = new Wrapper_TimetableWishComponent();
...
class View_TimetableWishComponent1 extends import2.AppView<any> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    const currVal_11:any = import3.inlineInterpolate(1,' ',this.parentView.context.timetableWish.wish_message,' ');
    if (import3.checkBinding(throwOnChange,this._expr_11,currVal_11)) {
      this.renderer.setText(this._text_5,currVal_11);
      this._expr_11 = currVal_11;
    }
    const currVal_12:any = import3.inlineInterpolate(1,' ',this.parentView.context.timetableWish.wish_by,' ');
...
export class View_TimetableWishComponent0 extends import2.AppView<import0.TimetableWishComponent> {
  ...
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    ...
    this._el_0 = import3.createRenderElement(this.renderer,parentRenderNode,'div',new import3.InlineArray2(2,'class','page-footer'),(null as any));
    this._text_1 = this.renderer.createText(this._el_0,'\n    ',(null as any));
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    const currVal_2_0_0:any = this.context.timetableWish;
  ...
  createEmbeddedViewInternal(nodeIndex:number):import2.AppView<any> {
    if ((nodeIndex == 2)) { return new View_TimetableWishComponent1(this.viewUtils,this,2,this._anchor_2,this._vc_2); }
    return (null as any);
  }
}