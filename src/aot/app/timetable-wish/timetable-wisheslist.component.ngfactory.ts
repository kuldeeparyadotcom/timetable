...
import * as import12 from '../../../app/timetable-auth/timetable-auth.service';
...
class View_TimetableWisheslistComponent1 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._TimetableWishComponent_0_3 = new import10.Wrapper_TimetableWishComponent(this.parentView.parentView.injectorGet(import12.TimetableAuthService,this.parentView.parentIndex));
...
export class View_TimetableWisheslistComponent0 extends import1.AppView<import0.TimetableWisheslistComponent> {
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._RouterLinkWithHref_2_3 = new import13.Wrapper_RouterLinkWithHref(this.parentView.injectorGet(import15.Router,this.parentIndex),this.parentView.injectorGet(import16.ActivatedRoute,this.parentIndex),this.parentView.injectorGet(import17.LocationStrategy,this.parentIndex));
    ...
    this._NgFor_10_6 = new import14.Wrapper_NgFor(this._vc_10.vcRef,this._TemplateRef_10_5,this.parentView.injectorGet(import19.IterableDiffers,this.parentIndex),this.ref);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import21.NgFor) && (10 === requestNodeIndex))) { return this._NgFor_10_6.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
