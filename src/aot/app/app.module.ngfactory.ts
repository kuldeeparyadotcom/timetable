...
import * as import44 from '../../app/timetable-items-tips/timetable-items-tips.component';
import * as import45 from '../../app/timetable-wish/timetable-wisheslist.component';
import * as import46 from '@angular/router/src/url_handling_strategy';
import * as import47 from '@angular/router/src/route_reuse_strategy';
...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  get _APP_ID_19():any {
    if ((this.__APP_ID_19 == null)) { (this.__APP_ID_19 = import37._appIdRandomProviderFactory()); }
  ...
  get _EventManager_23():import15.EventManager {
    if ((this.__EventManager_23 == null)) { (this.__EventManager_23 = new import15.EventManager(this._EVENT_MANAGER_PLUGINS_22,this.parent.get(import40.NgZone))); }
  ...
  get _RootRenderer_28():any {
    if ((this.__RootRenderer_28 == null)) { (this.__RootRenderer_28 = import41._createConditionalRootRenderer(this._DomRootRenderer_26,this.parent.get(import41.NgProbeToken,(null as any)),this._NgProbeToken_27)); }
  ...
  get _AnimationQueue_31():import19.AnimationQueue {
    if ((this.__AnimationQueue_31 == null)) { (this.__AnimationQueue_31 = new import19.AnimationQueue(this.parent.get(import40.NgZone))); }
  ...
  get _LocationStrategy_45():any {
    if ((this.__LocationStrategy_45 == null)) { (this.__LocationStrategy_45 = import7.provideLocationStrategy(this.parent.get(import42.PlatformLocation),this.parent.get(import43.APP_BASE_HREF,(null as any)),this._ROUTER_CONFIGURATION_44)); }
  ...
  get _ROUTES_50():any[] {
      if ((this.__ROUTES_50 == null)) { (this.__ROUTES_50 = [[
        ...
        {
          path: 'timetable',
          component: import44.TimetableItemsTipsComponent
        }
        ,
        {
          path: 'wishes',
          component: import45.TimetableWisheslistComponent
        }
  ...
  createInternal():import1.AppModule {
    ...
    this._ROUTER_FORROOT_GUARD_5 = import7.provideForRootGuard(this.parent.get(import48.Router,(null as any)));
    ...
    this._Testability_15 = new import11.Testability(this.parent.get(import40.NgZone));
    this._ApplicationRef__16 = new import12.ApplicationRef_(this.parent.get(import40.NgZone),this.parent.get(import49.Console),this,this._ErrorHandler_11,this,this._ApplicationInitStatus_14,this.parent.get(import11.TestabilityRegistry,(null as any)),this._Testability_15);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import37.APP_ID)) { return this._APP_ID_19; }
    ...
    if ((token === import53.RootRenderer)) { return this._RootRenderer_28; }
    if ((token === import18.DomSanitizer)) { return this._DomSanitizer_29; }
    if ((token === import54.Sanitizer)) { return this._Sanitizer_30; }
    if ((token === import19.AnimationQueue)) { return this._AnimationQueue_31; }
    if ((token === import20.ViewUtils)) { return this._ViewUtils_32; }
    if ((token === import55.IterableDiffers)) { return this._IterableDiffers_33; }
    if ((token === import56.KeyValueDiffers)) { return this._KeyValueDiffers_34; }
    ...
    if ((token === import43.LocationStrategy)) { return this._LocationStrategy_45; }
    ...
    if ((token === import59.NgModuleFactoryLoader)) { return this._NgModuleFactoryLoader_49; }
    if ((token === import60.ROUTES)) { return this._ROUTES_50; }
    if ((token === import48.Router)) { return this._Router_51; }
    if ((token === import61.ActivatedRoute)) { return this._ActivatedRoute_52; }
    ...
    if ((token === import37.APP_BOOTSTRAP_LISTENER)) { return this._APP_BOOTSTRAP_LISTENER_58; }
